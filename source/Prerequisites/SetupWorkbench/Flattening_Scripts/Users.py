...
with open("C:/Users/Ramya Ravikanti/Desktop/users.json", 'r') as file:
    data = json.load(file)
...
with open("C:/Users/Ramya Ravikanti/Desktop/users_flat.json", 'w') as outfile:
